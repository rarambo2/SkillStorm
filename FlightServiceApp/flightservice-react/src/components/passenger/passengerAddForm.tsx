...
export const PassengerAddForm = (props:any)=>{
    ...
    if(passengerid === undefined && !addNewPassenger){
        ...
        if(addNewPassenger){
            ...
            return (
                <form className="bg-info p-2  mt-3 sticky-top " onSubmit={(e:any) => {setInit(true); handleCreate({
                    Id : passId,
                    FirstName : passFName,
                    LastName : passLName,
                    Age : passAge,
                ...
                <div className ="form-group">
                    ...
                    <input required
                        type="text"
                     className="form-control border-dark" id="passengerFirstNameField" value={passFName}  onChange = {
                        (e:any) => setPassFName(e.target.value)}/>
                </div>   
                <div className ="form-group">
                    <label htmlFor="passengerLastNameField">Last Name</label>
                    <input required className="form-control border-dark" id="passengerLastNameField" value={passLName}  onChange = {
                ...
                <div className ="form-group">
                    ...
                    <input required className="form-control border-dark" id="passengerAgeField" value={(passAge === -1)?"" : passAge}  type="number" onChange={
                ...
                <div className="form-group">
                    ...
                    <input type="email" className="form-control border-dark" id="passengerEmailField" aria-describedby="emailHelp" value={passEmail}  onChange={
                        (e:any) => setPassEmail(e.target.value)}/>
                </div>
                <div className ="form-group">
                    <label htmlFor="passengerJobField">Occupation</label>
                    <input className="form-control border-dark" id="passengerJobField" value={passJob}  onChange={
        ...
        return(
            ...
            <form className="bg-info p-2  sticky-top mt-3" onSubmit={(e:any) => {setInit(true); handleSubmit({
                Id : passenger.Id,
                FirstName : passFName,
                LastName : passLName,
                Age : passAge,
            ...
            {/* <div className ="form-group">
                ...
                <input className="form-control bordar-dark" id="passengerIdField" value={passId} placeholder={passId} readOnly={true}/>
            </div> */}
            <div className ="form-group">
                <label htmlFor="passengerFirstNameField">First Name</label>
                <input required className="form-control border-dark" id="passengerFirstNameField" value={passFName} placeholder={passFName} onChange = {
                    (e:any) => setPassFName(e.target.value)}/>
            </div>   
            <div className ="form-group">
                <label htmlFor="passengerLastNameField">Last Name</label>
                <input required className="form-control border-dark" id="passengerLastNameField" value={passLName} placeholder={passLName} onChange = {
                    (e:any) => setPassLName(e.target.value)}/>
            </div>
            <div className ="form-group">
                <label htmlFor="passengerAgeField">Age</label>
                <input required className="form-control border-dark" id="passengerAgeField" value={passAge} placeholder={passAge} onChange={
                    (e:any) => setPassAge(e.target.value)}/>
            </div>                                           
            <div className="form-group">
                <label form="passengerEmailField">Email address</label>
                <input type="email" className="form-control border-dark" id="passengerEmailField" aria-describedby="emailHelp" value={passEmail} placeholder={passEmail} onChange={
                    (e:any) => setPassEmail(e.target.value)}/>
            </div>
            <div className ="form-group">
                <label htmlFor="passengerJobField">Occupation</label>
                <input className="form-control border-dark" id="passengerJobField" value={passJob} placeholder={passJob} onChange={
                    (e:any) => setPassJob(e.target.value)}/>
            </div>            
            <button type="reset" className="btn btn-primary m-2 border-dark" onClick={(e:any) => handleCancel(dispatch,e)}>Cancel</button>
            <button type="submit" className="btn btn-primary m-2 border-dark">Save</button>
