...
export const PassengerAddForm = (props: any) => {
    ...
    if (passengerid === undefined && !addNewPassenger) {
        ...
        if (addNewPassenger) {
            ...
            return (
                <form className="bg-info p-2  mt-3 sticky-top " onSubmit={(e: any) => {
                    setInit(true); handleCreate({
                        Id: passId,
                        FirstName: passFName,
                        LastName: passLName,
                        Age: passAge,
        ...
        return (
            ...
            <form className="bg-info p-2  sticky-top mt-3" onSubmit={(e: any) => {
                setInit(true); handleSubmit({
                    Id: passenger.Id,
                    FirstName: passFName,
                    LastName: passLName,
                    Age: passAge,
